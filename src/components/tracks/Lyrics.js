...
class Lyrics extends Component {
  ...
  render() {
    ...
    //console.log(track);
    // check to see if track / lyrics have loaded, if not show spinner loading graphic
    if (
      track === undefined ||
      lyrics === undefined ||
      ...
      // Back button & track details (artist name, lyrics, album ID, music genre, release date, explicit)
      return (
        <React.Fragment>
          ...
          <ul className="list-group mt-3">
            ...
            <li className="list-group-item">
              {track.explicit === 0 ? "" : <strong>Explicit</strong>}
            </li>
          </ul>
        </React.Fragment>
      );
